...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 11-09-2023 a las 22:21:54
...
--
-- Base de datos: `desfrilibradores`
--

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `dea_registrados`
--

CREATE TABLE `dea_registrados` (
  `id` bigint(20) NOT NULL,
  `Nombre_Completo` varchar(150) NOT NULL,
  `Documento_Identificacion` varchar(22) NOT NULL,
  `Cantidad` int(11) NOT NULL,
  `Nombre_Ubicacion` varchar(120) NOT NULL,
  `Direccion_Ubicacion` varchar(120) NOT NULL,
  `Codigo_Postal` varchar(20) NOT NULL,
  `Ciudad_Municipio` int(11) NOT NULL,
  `Departamento` int(11) NOT NULL,
  `Tipo_Instalacion` int(11) NOT NULL,
  `TipoDeclaracion` int(11) NOT NULL,
  `Tipo_Espacio` int(11) NOT NULL,
  `Num_Serie` varchar(60) NOT NULL,
  `Modelo` varchar(60) NOT NULL,
  `Marca` varchar(60) NOT NULL,
  `Importador_Distribuidor` varchar(120) NOT NULL,
  `Descripcion_Lugar_Ubicacion` text NOT NULL,
  `GPS` varchar(100) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;

--
-- Volcado de datos para la tabla `dea_registrados`
--

INSERT INTO `dea_registrados` (`id`, `Nombre_Completo`, `Documento_Identificacion`, `Cantidad`, `Nombre_Ubicacion`, `Direccion_Ubicacion`, `Codigo_Postal`, `Ciudad_Municipio`, `Departamento`, `Tipo_Instalacion`, `TipoDeclaracion`, `Tipo_Espacio`, `Num_Serie`, `Modelo`, `Marca`, `Importador_Distribuidor`, `Descripcion_Lugar_Ubicacion`, `GPS`) VALUES
(1, 'Marta Sanchez X', '900856789', 5, 'Belen alameda', 'Diagonal 74', '0545', 1, 1, 1, 2, 1, '0400600255', '45f600jfy', 'Dos tierras', 'Aire LM', 'Espacio cerrado', '6.256767,-75.5927478');
...
--
-- Estructura de tabla para la tabla `tipo_declaracion`
--

CREATE TABLE `tipo_declaracion` (
  `id` int(11) NOT NULL,
  `Tipo` varchar(60) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;

--
-- Volcado de datos para la tabla `tipo_declaracion`
--

INSERT INTO `tipo_declaracion` (`id`, `Tipo`) VALUES
(1, 'Test declaracionX');
...
INSERT INTO `tipo_espacio` (`id`, `Tipo`) VALUES
(1, 'Test declaracionX');
...
(1, 'Teresa Luna', 'teresa@gmail.com', '$2b$10$F6H4jsM8m8Y6.rnZOoIHX.omGQAGuEDFo6aU8oj40Mn.Pqj4f.sOO', 'm86AXYRal0xwMjWEQEmR', 'iMzkhGIEnObnq0A4Zwhf', 0, 0, 'Cliente', '3185772585', '1980-08-26', '2023-09-11 18:30:12');
...
--
-- Indices de la tabla `dea_registrados`
--
ALTER TABLE `dea_registrados`
  ADD PRIMARY KEY (`id`);
...
--
-- Indices de la tabla `tipo_declaracion`
--
ALTER TABLE `tipo_declaracion`
  ADD PRIMARY KEY (`id`);
...
--
-- AUTO_INCREMENT de la tabla `dea_registrados`
--
ALTER TABLE `dea_registrados`
...
--
-- AUTO_INCREMENT de la tabla `tipo_declaracion`
--
ALTER TABLE `tipo_declaracion`
